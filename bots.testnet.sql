INSERT INTO bots (rank, name, description, pairing_code) VALUES (
   ...
   'AxBxXDnPOzE/AxLHmidAjwLPFtQ6dK3k70zM0yKVeDzC@bytes.org/bb-test#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   'Exchange Bot',
   ...
   'AmHJoA4hmRFMqxtaumnc7ZSc+hGhZq3SzkCBgeNam2B4@bytes.org/bb-test#0000'
);
...
Developer: pxrunes, https://github.com/byteball/luckybytes',
    'AkotTj99TWGO0rVR9h/+D113M3H54pAiWxfBaMh7phRQ@bytes.org/bb-test#0000'
);
