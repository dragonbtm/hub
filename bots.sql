...
Developer: Laurentiu-Andronache, https://github.com/Laurentiu-Andronache/bytes-chatbot-Rosie',
	'ApOpqXbI7GpqOl3Z96QW/GSNgv04g4RcFr/xpaDmN9cg@bytes.org/bb#0000'
);
*/
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Asset Manager',
	'Asset directory and asset creation platform for bytes. The chatbot provides a simple yet powerful interface to define and issue custom assets. Assets behave similarly to the native currency "bytes": they are transferable and exchangeable. They can represent anything that has value such as debt, shares, loyalty points, airtime minutes, commodities, other fiat or crypto currencies.

Developer: Peter Miklos, https://bytes.market',
...
Source code: https://github.com/bytes/poll-bot',
	'AhMVGrYMCoeOHUaR9v/CZzTC34kScUeA4OBkRCxnWQM+@bytes.org/bb#0000'
);
/*
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Source code: https://github.com/bytes/conditional-token-sale, you can use it to sell your tokens.',
	'AmXiHW7Ms4qcdmXeLW4U/ou5lv4HFnijYBGWGKfgT6bM@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
   ...
   'AsYnI7C8WuXqb2aLMSr0nfpLC+u3FRSLWwkp1e9ib15Z@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Fun-coins faucet',
...
INSERT INTO bots (name, description, pairing_code) VALUES (
   'SilentNotary ICO',
   'SilentNotary is a digital notary that saves and certifies documents, emails, chats, and audio/video recordings.  The authenticity of these records will be ensured by posting them both to Ethereum blockchain and bytes DAG.  The ICO is active until 15 March 2018, and you can buy SNTR tokens with Bytes, BTC, or Ether.

Website: https://silentnotary.com',
   'Aop8UNeUm4Qtu0q2frAaVwkQtQiNGKYVL8NvdQYgrR+v@bytes.org/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   'Email attestation bot',
   'Verify your email adddress, and your payers don''t need to know your bytes address any longer, they just write your email address as recipient.    After first successful verification, you are rewarded with $10.00 worth of Bytes from the distribution fund if your email is on one of whitelisted domains.',
   'Al+nIuRMIr8PGvi3BkIVU+S/VZ1Xm2SM3yR3z4IoyMbJ@bytes.org/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   'Exchange Bot',
   'Exchange bytes-issued tokens against Bytes or token vs token.  The exchange is based on smart contracts, so you don''t have to trust the exchange operator.',
   'A8GXYB3lSvSsvej+ZQgfF2prwx8gopMx8j5JwwUS9ZVD@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Worldopoly ICO',
   'Worldopoly is the world’s first mobile game combining AR, AI, Geolocationing, Blockchain, and DAG. The ICO is active until 17 May 2018, and you can buy WPT tokens with Bytes, BTC, or Ether.  WPT token is issued both on bytes and Ethereum platforms but investors on bytes platform receive increased bonus (even if they pay in ETH or BTC) for investments up to 30 ETH.

Website: https://worldopoly.io',
   'AwyoKVsyxajATgLXa9Jhh8NBRTnUaZNHdi85c43g+GoJ@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
开发者：123cb.net',
   'Ahe4jkq5GvgLQ2h5ftqRMjWBBumUEN96tWoSfEQ9TGHF@bytes.org/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	3,
   ...
   'A1i/ij0Na4ibEoSyEnTLBUidixtpCUtXKjgn0lFDRQwK@bytes.org/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   ...
   'A/qkC0pkuz6ofhAX78PK2omu42VdkFRa5d+vtjLvIvz+@bytes.org/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	3,
   'World Community Grid linking bot',
   'Donate your device’s spare computing power to help scientists solve the world’s biggest problems in health and sustainability, and earn some Bytes in the meantime.  This bot allows you to link your bytes address and WCG account in order to receive daily rewards for your contribution to WCG computations.

WCG is an IBM sponsored project, more info at https://www.worldcommunitygrid.org',
   'A/JWTKvgJQ/gq9Ra+TCGbvff23zqJ9Ec3Bp0XHxyZOaJ@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Exchange bot for dual-chain tokens',
   'For tokens issued both on bytes and Ethereum platforms, the bot enables seamless exchange between bytes and Ethereum tokens.

Developer: HDRProtocol, https://github.com/HDRProtocol/exchanger',
   'A+dAU2j/Tm9lnlmc2SryltsfVzOq9GLPxccAq+dClCxr@bytes.org/bb#f7b42a61a3ba6a34cbeeb18d37979927ad1103fc'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Private chat room bot',
   'This chatbot allows several persons to chat together using the bytes messaging system. The bot decrypts messages and relays them to other users after reencryption. For best privacy, run your own instance of this bot using the source code below, any cheap VPS is enough to host it.

Developer: Papabyte, https://github.com/Papabyte/Private-chat-room',
   'AuB9N1V8OOdc9M5JrpNOCqI3LAcLWetitkT3MqK/Ij5U@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Aworker ICO',
...
Proceeds from the sale of usernames go to bytes community fund and help fund the development and promotion of the platform.',
   'A52nAAlO05BLIfuoZk6ZrW5GjJYvB6XHlCxZBJjpax3c@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Nousplatform ICO',
...
Website: https://nousplatform.com',
   'A6K87dFpPsYgLH3S+5ekN6/OUiLCAE1JyE7bgcMcQYR3@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Whitelittle reward chat room',
   'Whitelittle is a chat room for newcomer who want to enter the blockchain industry. The purpose is to bulid an information discovery ecological platform that provides effective help for newcomer based on the bytes technology. Here you can chat and help others without being censored and get some rewards.',
   'A0DQNw3dCVSOdBhDFYShaf4ZY107Tfk9H7b7LndtXAVc@bytes.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
   'Dice bot',
...
Developer: Evgeny Stulnikov',
   'AoytQbCrauzJ7q9iP9OxvgXIaEtbtlgWYSdyVy6cxHC6@bytes.org/bb#play'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Website: https://clearcost.io',
   'AohcgBmUWV729vYhvzzxoE9Au+egHEN0APGy1D+vOY2T@bytes.org/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	3,
   'Draw Airdrop',
